...
final class ProductUpdateService
{
    ...
    public function update(string $uuid, array $payload): Product
    {
        ...
        $product->fill([
            ...
            'type' => array_key_exists('type', $payload) ? $payload['type'] : $product->type,
            'department' => array_key_exists('department', $payload) ? $payload['department'] : $product->department,
            'manufacturer' => array_key_exists('manufacturer', $payload) ? $payload['manufacturer'] : $product->manufacturer,
            'franchise' => array_key_exists('franchise', $payload) ? $payload['franchise'] : $product->franchise,
            'product_line' => array_key_exists('product_line', $payload) ? $payload['product_line'] : $product->product_line,
            'subline' => array_key_exists('subline', $payload) ? $payload['subline'] : $product->subline,
            'grade' => array_key_exists('grade', $payload) ? $payload['grade'] : $product->grade,
            'scale' => array_key_exists('scale', $payload) ? $payload['scale'] : $product->scale,
            'series' => array_key_exists('series', $payload) ? $payload['series'] : $product->series,
