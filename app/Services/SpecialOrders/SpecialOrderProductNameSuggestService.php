...
use App\DTOs\SpecialOrders\SpecialOrderProductNameSuggestionDTO;
...
final class SpecialOrderProductNameSuggestService
{
    ...
    /**
     * @return array<int, SpecialOrderProductNameSuggestionDTO>
     */
    ...
    private function parseGundamHangarResponse(?Response $res, string $term, int $limit): array
    {
        ...
        try {
            ...
            foreach ($items as $item) {
                ...
                $scored[] = [
                    'score' => $score,
                    'dto' => new SpecialOrderProductNameSuggestionDTO(
                        title: $title,
            ...
            return array_map(
                static fn (array $row): SpecialOrderProductNameSuggestionDTO => $row['dto'],
    ...
    /**
     * @param  array<int, SpecialOrderProductNameSuggestionDTO>  $suggestions
     * @return array<int, SpecialOrderProductNameSuggestionDTO>
     */
