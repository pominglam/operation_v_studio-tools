...
final class SpecialOrderLandedCostService
{
    ...
    public function compute(
        ...
        $productCurrency = SpecialOrderCurrency::frankfurterCode($productCurrency);
        $shippingCurrency = SpecialOrderCurrency::frankfurterCode($shippingCurrency);

        $productFx = $this->fxRates->rate($productCurrency, SpecialOrderCurrency::CAD);
        $shippingFx = $this->fxRates->rate($shippingCurrency, SpecialOrderCurrency::CAD);
