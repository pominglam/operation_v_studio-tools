...
final class SpecialOrderVisualKind
{
    ...
    public static function pathOn(SpecialOrder $order, string $kind): ?string
    {
    ...
    public static function mimeOn(SpecialOrder $order, string $kind): ?string
    {
        $columns = self::columns($kind);
    ...
    public static function filenameOn(SpecialOrder $order, string $kind): ?string
    {
        $columns = self::columns($kind);
