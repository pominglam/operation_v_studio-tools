...
final class SpecialOrderCustomerPricing
{
    ...
    public static function opvSpread(
        ...
        if ($merchandiserCommission === null) {
            return null;
        }

        return number_format($landed + (float) $merchandiserCommission, 2, '.', '');
    }
    ...
    public static function ourCommission(
        ...
        if ($ourMultiplier !== null && (float) $ourMultiplier >= 1) {
            $merchandiserCommission = self::merchandiserCommission(
                $landedCostCad,
                $merchandiserPriceCad,
                $merchandiserCommissionOverrideCad,
            ...
            return SpecialOrderPricingCaps::applyCap(
                number_format($spread * ((float) $ourMultiplier - 1), 2, '.', ''),
                $opvMarginCapCad,
            );
        }
