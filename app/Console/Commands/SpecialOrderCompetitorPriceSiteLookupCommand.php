...
final class SpecialOrderCompetitorPriceSiteLookupCommand extends Command
{
    protected $signature = 'special-orders:competitor-price-site {site_key : Stable site key}';

    protected $description = 'Lookup one competitor price for a product name (used by parallel refresh workers)';

    public function handle(SpecialOrderCompetitorPriceLookupService $lookup): int
    {
