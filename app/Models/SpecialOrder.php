 ...
 * @property string|null $shipping_cost_input_mode
 * @property string|null $shipping_weight_kg
 ...
 * @property string|null $actual_shipping_cost_input_mode
 * @property string|null $actual_shipping_weight_kg
 ...
 * @property \Illuminate\Support\Carbon|null $customer_considering_at
 * @property \Illuminate\Support\Carbon|null $deposit_received_at
 * @property \Illuminate\Support\Carbon|null $balance_received_at
 * @property string|null $cash_received_cad
 * @property \Illuminate\Support\Carbon|null $cash_received_at
 * @property string|null $shopify_customer_gid
 * @property string|null $shopify_deposit_draft_order_gid
 * @property string|null $shopify_deposit_draft_order_legacy_id
 * @property string|null $shopify_deposit_draft_order_name
 * @property string|null $shopify_deposit_invoice_url
 * @property \Illuminate\Support\Carbon|null $shopify_deposit_invoice_sent_at
 * @property string|null $shopify_balance_draft_order_gid
 * @property string|null $shopify_balance_draft_order_legacy_id
 * @property string|null $shopify_balance_draft_order_name
 * @property string|null $shopify_balance_invoice_url
 * @property \Illuminate\Support\Carbon|null $shopify_balance_invoice_sent_at
 ...
 */
final class SpecialOrder extends Model
{
    ...
    protected $casts = [
        ...
        'actual_shipping_weight_kg' => 'decimal:3',
        ...
        'customer_considering_at' => 'datetime',
        'deposit_received_at' => 'datetime',
        'balance_received_at' => 'datetime',
        'cash_received_cad' => 'decimal:2',
        'cash_received_at' => 'datetime',
        'shopify_deposit_invoice_sent_at' => 'datetime',
        'shopify_balance_invoice_sent_at' => 'datetime',
