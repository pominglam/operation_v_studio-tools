...
final class InventoryCheckItemResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'notes' => $item->notes,
            'selling_price_snapshot' => $this->money2($item->selling_price_snapshot),
            'landed_unit_cost_snapshot' => $this->money2($item->landed_unit_cost_snapshot),
            'match_status' => $item->match_status,
            'match_error' => $item->match_error,
            'issue_flag' => (bool) $item->issue_flag,
