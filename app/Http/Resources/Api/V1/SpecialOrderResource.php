...
use App\Support\Shopify\ShopifyDraftOrderAdminUrl;
use Illuminate\Http\Request;
use Illuminate\Http\Resources\Json\JsonResource;

/** @mixin SpecialOrder */
final class SpecialOrderResource extends JsonResource
{
    /** @return array<string, mixed> */
    public function toArray(Request $request): array
    {
        /** @var SpecialOrderPricingCapsService $capsService */
        $capsService = app(SpecialOrderPricingCapsService::class);
        $caps = $capsService->getCaps();

        return [
            'id' => $this->uuid,
            'customer_contact_media' => $this->customer_contact_media,
            'customer_contact_media_label' => SpecialOrderContactMedia::label((string) $this->customer_contact_media),
            'customer_contact_value' => $this->customer_contact_value,
            'product_name' => $this->product_name,
            'vendor' => $this->vendor,
            'customer_visual' => $this->visualPayload(SpecialOrderVisualKind::CUSTOMER),
            'product_visual' => $this->visualPayload(SpecialOrderVisualKind::PRODUCT),
            'merchandiser_order_proof_visual' => $this->visualPayload(SpecialOrderVisualKind::MERCHANDISER_ORDER_PROOF),
            ...
            'product_cost_currency_label' => is_string($this->product_cost_currency)
                ? SpecialOrderCurrency::label($this->product_cost_currency)
                : null,
            'shipping_cost_amount' => $this->shipping_cost_amount,
            'shipping_cost_currency' => $this->shipping_cost_currency,
            'shipping_cost_input_mode' => SpecialOrderShippingCost::normalizeMode($this->shipping_cost_input_mode),
            'shipping_weight_kg' => $this->shipping_weight_kg,
            'shipping_cost_currency_label' => is_string($this->shipping_cost_currency)
                ? SpecialOrderCurrency::label($this->shipping_cost_currency)
                : null,
            ...
            'receive_delay_unit_label' => is_string($this->receive_delay_unit)
                ? SpecialOrderReceiveDelayUnit::label($this->receive_delay_unit)
                : null,
            'receive_delay_days' => $this->receive_delay_days,
            'receive_delay_label' => SpecialOrderReceiveDelayUnit::formatLabel(
            ...
            'actual_product_cost_currency_label' => is_string($this->actual_product_cost_currency)
                ? SpecialOrderCurrency::label($this->actual_product_cost_currency)
                : null,
            ...
            'actual_shipping_cost_input_mode' => SpecialOrderShippingCost::normalizeMode(
                $this->actual_shipping_cost_input_mode,
            ),
            'actual_shipping_weight_kg' => $this->actual_shipping_weight_kg,
            'actual_shipping_cost_currency_label' => is_string($this->actual_shipping_cost_currency)
                ? SpecialOrderCurrency::label($this->actual_shipping_cost_currency)
                : null,
            ...
            'actual_receive_delay_unit_label' => is_string($this->actual_receive_delay_unit)
                ? SpecialOrderReceiveDelayUnit::label($this->actual_receive_delay_unit)
                : null,
            'actual_receive_delay_days' => $this->actual_receive_delay_days,
            'actual_receive_delay_label' => SpecialOrderReceiveDelayUnit::formatLabel(
            ...
            'formula_merchandiser_price_cad' => SpecialOrderCustomerPricing::formulaPrice(
                is_string($this->landed_cost_cad) ? $this->landed_cost_cad : null,
                $this->formatMultiplier($this->merchandiser_price_multiplier),
                SpecialOrderCustomerPricing::DEFAULT_MERCHANDISER_MULTIPLIER,
            ),
            'effective_merchandiser_multiplier' => SpecialOrderCustomerPricing::effectiveMultiplier(
                is_string($this->landed_cost_cad) ? $this->landed_cost_cad : null,
                is_string($this->merchandiser_price_cad) ? $this->merchandiser_price_cad : null,
            ),
            'merchandiser_commission_cad' => SpecialOrderCustomerPricing::merchandiserCommission(
                is_string($this->landed_cost_cad) ? $this->landed_cost_cad : null,
                is_string($this->merchandiser_price_cad) ? $this->merchandiser_price_cad : null,
            ...
            'formula_our_price_cad' => SpecialOrderCustomerPricing::formulaPrice(
                SpecialOrderCustomerPricing::opvSpread(
                    is_string($this->landed_cost_cad) ? $this->landed_cost_cad : null,
                    is_string($this->merchandiser_price_cad) ? $this->merchandiser_price_cad : null,
                    is_string($this->merchandiser_commission_override_cad) ? $this->merchandiser_commission_override_cad : null,
                    $this->formatMultiplier($this->merchandiser_price_multiplier),
                ...
                SpecialOrderCustomerPricing::DEFAULT_OUR_MULTIPLIER,
            ),
            'effective_our_multiplier' => SpecialOrderCustomerPricing::effectiveMultiplier(
                is_string($this->landed_cost_cad) ? $this->landed_cost_cad : null,
                is_string($this->customer_price_cad) ? $this->customer_price_cad : null,
            ),
            'our_commission_cad' => SpecialOrderCustomerPricing::ourCommission(
                is_string($this->landed_cost_cad) ? $this->landed_cost_cad : null,
                is_string($this->merchandiser_price_cad) ? $this->merchandiser_price_cad : null,
                is_string($this->customer_price_cad) ? $this->customer_price_cad : null,
            ...
            'deposit_amount_cad' => SpecialOrderCustomerPricing::depositAmount(
                is_string($this->customer_price_cad) ? $this->customer_price_cad : null,
            ...
            'balance_cad' => SpecialOrderCustomerPricing::balance(
                is_string($this->customer_price_cad) ? $this->customer_price_cad : null,
                $this->formatPercent($this->deposit_percent),
                is_string($this->deposit_amount_override_cad) ? $this->deposit_amount_override_cad : null,
            ),
            ...
            'customer_considering_at' => $this->customer_considering_at?->toIso8601String(),
            'deposit_received_at' => $this->deposit_received_at?->toIso8601String(),
            'balance_received_at' => $this->balance_received_at?->toIso8601String(),
            'cash_received_cad' => $this->cash_received_cad,
            'cash_received_at' => $this->cash_received_at?->toIso8601String(),
            'shopify_invoices' => $this->shopifyInvoicesPayload(),
            ...
            'competitor_prices_target_sites' => SpecialOrderCompetitorPriceSites::siteOptionsForScope(
                $this->competitor_prices_refresh_scope
                    ?? ($this->competitor_prices_fetched_at !== null
                        ? SpecialOrderCompetitorPriceSites::SCOPE_FULL
                        : SpecialOrderCompetitorPriceSites::SCOPE_FAST),
            ),
            'notes' => $this->notes,
    ...
    {
        $path = SpecialOrderVisualKind::pathOn($this->resource, $kind);
        if ($path === null) {
            return null;
        }

        $filename = SpecialOrderVisualKind::filenameOn($this->resource, $kind);
        $mime = SpecialOrderVisualKind::mimeOn($this->resource, $kind);

        return [
            'url' => '/api/v1/special-orders/'.$this->uuid.'/visuals/'.$kind,
            'filename' => $filename,
            'mime_type' => $mime,
        ];
    }
    ...
    private function competitorPriceQuotesPayload(): array
    {
        ...
        foreach (array_values($this->competitor_price_quotes_json) as $quote) {
            ...
            if ($siteKey !== '' && ! isset($quote['site_url'])) {
                $quote['site_url'] = SpecialOrderCompetitorPriceSites::siteUrl($siteKey);
            }
    ...
    /** @return array<string, mixed> */
    private function shopifyInvoicesPayload(): array
    {
        return [
            'customer_gid' => $this->shopify_customer_gid,
            'deposit' => $this->shopifyInvoicePartPayload(
                $this->shopify_deposit_draft_order_gid,
                $this->shopify_deposit_draft_order_legacy_id,
                $this->shopify_deposit_draft_order_name,
                $this->shopify_deposit_invoice_url,
                $this->shopify_deposit_invoice_sent_at,
            ),
            'balance' => $this->shopifyInvoicePartPayload(
                $this->shopify_balance_draft_order_gid,
                $this->shopify_balance_draft_order_legacy_id,
                $this->shopify_balance_draft_order_name,
                $this->shopify_balance_invoice_url,
                $this->shopify_balance_invoice_sent_at,
            ),
        ];
    }
     ...
     */
    private function shopifyInvoicePartPayload(
        ?string $gid,
        ?string $legacyId,
        ?string $name,
        ?string $invoiceUrl,
        ...
        return [
            'draft_order_gid' => $gid,
            'draft_order_legacy_id' => $legacyId,
            'draft_order_name' => $name,
            'admin_url' => ShopifyDraftOrderAdminUrl::forLegacyId($legacyId),
