...
final class SpecialOrderCustomerMessageTemplateUpdateRequest extends FormRequest
{
    /**
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            ...
            try {
                \App\Support\SpecialOrders\SpecialOrderCustomerMessageTemplate::assertPlaceholders(trim($body));
