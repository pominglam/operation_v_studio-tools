...
final class SpecialOrderShopifyBalanceInvoiceController extends Controller
{
    ...
    public function __invoke(string $id, SpecialOrderShopifyInvoiceRequest $request): JsonResponse|SpecialOrderResource
    {
        ...
        try {
            $customerGid = $this->resolveOptionalCustomerGid($validated);
            $order = $this->invoices->createBalanceInvoice(
                $id,
     ...
     */
    private function resolveOptionalCustomerGid(array $validated): ?string
    {
