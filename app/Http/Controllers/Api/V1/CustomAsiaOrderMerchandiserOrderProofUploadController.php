...
final class CustomAsiaOrderMerchandiserOrderProofUploadController extends Controller
{
    ...
    public function __invoke(string $id, CustomAsiaOrderVisualUploadRequest $request): CustomAsiaOrderResource
    {
        ...
        $order = $this->uploads->upload($id, CustomAsiaOrderVisualUploadService::KIND_MERCHANDISER_ORDER_PROOF, $file);
