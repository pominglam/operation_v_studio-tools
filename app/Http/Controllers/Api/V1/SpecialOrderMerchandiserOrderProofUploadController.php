...
final class SpecialOrderMerchandiserOrderProofUploadController extends Controller
{
    ...
    public function __invoke(string $id, SpecialOrderVisualUploadRequest $request): SpecialOrderResource
    {
        ...
        $order = $this->uploads->upload($id, SpecialOrderVisualUploadService::KIND_MERCHANDISER_ORDER_PROOF, $file);
