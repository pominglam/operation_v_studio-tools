...
final class SpecialOrderMarkCustomerConsideringController extends Controller
{
    ...
    {
        return SpecialOrderResource::make($this->milestones->markCustomerConsidering($id));
    }
}
