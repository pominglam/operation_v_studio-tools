...
final class CustomAsiaOrderProductVisualUploadController extends Controller
{
    ...
    public function __invoke(string $id, CustomAsiaOrderVisualUploadRequest $request): CustomAsiaOrderResource
    {
        ...
        $order = $this->uploads->upload($id, CustomAsiaOrderVisualUploadService::KIND_PRODUCT, $file);
