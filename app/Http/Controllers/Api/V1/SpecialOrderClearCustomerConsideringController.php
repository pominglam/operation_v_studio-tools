...
final class SpecialOrderClearCustomerConsideringController extends Controller
{
    ...
    {
        return SpecialOrderResource::make($this->milestones->clearCustomerConsidering($id));
    }
}
