...
return new class extends Migration
{
    ...
    {
        Schema::create('special_orders', function (Blueprint $table): void {
            $table->bigIncrements('id');
            $table->uuid('uuid')->unique('unique_special_orders_uuid');
            ...
            $table->index(['customer_contact_media', 'created_at'], 'idx_special_orders_media_created');
            $table->index(['landed_cost_cad', 'created_at'], 'idx_special_orders_landed_created');
            $table->index('created_at', 'idx_special_orders_created_at');
            $table->index('updated_at', 'idx_special_orders_updated_at');
        });
    }
