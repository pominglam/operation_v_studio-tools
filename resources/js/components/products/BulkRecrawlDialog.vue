    ...
    >
      <div class="w-full max-w-lg rounded-lg bg-white p-4 shadow-xl">
        <div class="flex items-start justify-between gap-3">
          <div>
            <div class="text-sm font-semibold text-slate-900">Recrawl selected products</div>
        ...
        <div class="mt-4 space-y-2">
          <div class="text-xs font-semibold uppercase tracking-wide text-slate-600">Recrawl images</div>

          <label class="flex items-center gap-2 text-sm text-slate-800">
            <input v-model="sources.bandai" type="checkbox" class="h-4 w-4 rounded border-slate-300" :disabled="busy" />
            Bandai PDP (images + description + grade/series/scale + yen/launch date)
          </label>

          <label class="flex items-center gap-2 text-sm text-slate-800">
            <input v-model="sources.hlj" type="checkbox" class="h-4 w-4 rounded border-slate-300" :disabled="busy" />
          ...
          <div class="mt-4 text-xs font-semibold uppercase tracking-wide text-slate-600">Other</div>
