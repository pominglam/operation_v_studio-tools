...
import ProductsTable, { type ProductRow, type ProductSortKey, type UpdateProductPayload } from '../components/products/ProductsTable.vue';
  ...
  <section class="space-y-4">
    ...
    <div class="rounded-lg border border-slate-200 bg-white p-4">
      <div class="grid grid-cols-1 gap-3 md:grid-cols-4 md:items-end">
        ...
        <MultiSelectFilter v-model="selectedTypes" label="Type" :options="typeOptions" placeholder="All types" />
      ...
      <div class="mt-3 text-sm text-slate-600">
        Showing <span class="font-medium text-slate-900">{{ products.length }}</span> of
